...
if __name__ == '__main__':
	...
	URL = "https://candidate.hubteam.com/candidateTest/v2/partners?userKey=84b68d0807e8bd095e5883ab3d30"
	...
	r = requests.post(url="https://candidate.hubteam.com/candidateTest/v2/results?userKey=84b68d0807e8bd095e5883ab3d30", data=result)
	print r.status_code
	print r.json()
